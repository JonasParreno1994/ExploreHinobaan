import { EnterpriseTypeForm, type EnterpriseTypeFormData } from '@/components/admin/enterprise-type-form';
...
export default function CreateEnterpriseType() {
    const form = useForm<EnterpriseTypeFormData>({ name: '', description: '', status: 'active' });
            ...
            <Card className="mx-auto w-full max-w-3xl">
                ...
                <CardContent>
                    <form onSubmit={submit} className="grid gap-6">
                        <EnterpriseTypeForm data={form.data} errors={form.errors} onChange={form.setData} />
